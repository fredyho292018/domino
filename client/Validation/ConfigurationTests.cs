...
static class ConfigurationTests
{
    ...
    public static void Run()
    {
        ...
        Check(config.FinishScoring.Source == PointsSource.OpponentsOnly && config.BlockedScoring.Source == PointsSource.OpponentsOnly, "both bundled team scoring policies exclude the winning team");
        Check(config.FinishScoring.Bonus == 10 && config.BlockedScoring.Bonus == 0, "independent bonuses preserved");
        ...
        Check(RoundScoring.Evaluate(independent,new[]{5,20,30,40},-1,true,1).Award==60,"blocked policy unchanged");
