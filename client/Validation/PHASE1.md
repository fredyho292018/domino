...
La revisión original conservaba el cobro de otras tres manos. Esa política fue sustituida posteriormente para 2v2: salida y tranca cobran solo al equipo rival (ver `TEAM_SCORING.md`). Salida: asiento cero en todas las rondas. Empates consecutivos: conservar ×2, sin acumulación.
