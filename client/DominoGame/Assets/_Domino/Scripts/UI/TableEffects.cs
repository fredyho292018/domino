...
namespace Domino.UI
{
    ...
    public sealed class TableEffects : MonoBehaviour
    {
        ...
        public IEnumerator Knock(int player, Vector2? position = null)
        {
            ...
            var effect = Begin("Pass - two knocks", position ?? positions[player]);
            ...
            UiKit.LLabel("Pass", effect, "game.pass", new Vector2(120,26), new Vector2(0,-77), 18, UiKit.Gold);
        ...
        public IEnumerator Celebrate(string winner, bool match, bool localWon)
        {
            ...
            UiKit.LLabel("Title", card.transform, match ? (localWon ? "result.victory" : "result.defeat") : (localWon ? "result.round_won" : "result.round_lost"), new Vector2(490,40), new Vector2(0,15), 29, UiKit.Gold);
