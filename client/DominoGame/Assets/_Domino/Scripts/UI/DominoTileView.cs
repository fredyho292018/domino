...
namespace Domino.UI
{
    ...
    public sealed class DominoTileView : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        Image backLogo;
        bool compactBack;
        public void SetCompactBack(bool compact) { compactBack = compact; Refresh(); }
        ...
        void Refresh()
        {
            ...
            if (backBrand)
            {
                backBrand.text = compactBack ? "TF" : "TEAMFHO";
                backBrand.fontSize = compactBack ? 18 : 14;
                backBrand.rectTransform.sizeDelta = compactBack ? new Vector2(60,24) : new Vector2(86,20);
            }
            if (backLogo)
            {
                backLogo.sprite = compactBack ? TileStyles.BrandMark : TileStyles.BrandLogo;
                backLogo.rectTransform.sizeDelta = compactBack ? new Vector2(30,30) : new Vector2(86,25);
            }
        }
