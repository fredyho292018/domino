...
namespace Domino.UI
{
    ...
    public static class DominoVisualTheme
    {
        ...
        public static readonly Color Table = UiKit.Hex("10473D");
        public static readonly Color TableLight = UiKit.Hex("286E57");
        public static readonly Color Rail = UiKit.Hex("102A2C");
