...
namespace Domino.Online.Development { public static class TwoUnityValidationEditor {
        ...
        public static void Run(){
            Domino.Infrastructure.ValidationNetworkPolicy.AuthorizeReal();if(!Application.isBatchMode||!Application.dataPath.Replace('\\','/').Contains("/Validation/Generated/"))throw new Exception("ISOLATED_EDITOR_REQUIRED");SessionState.SetBool("I21.TwoUnity",true);EditorSceneManager.OpenScene(Domino.Editor.ClientEditorTools.ScenePath);EditorApplication.isPlaying=true;}
