    ...
    public static class DisplayProfileValidation
    {
        ...
        static void Tick()
        {
            ...
            try
            {
                ...
                if (controller && controller.Menu && controller.Session == null)
                {
                ...
                if (true) // Validate portrait safe-area geometry as well as development landscape.
                {
                ...
                results.Add($"{item.name} | {item.orientation.orientation} | {width}x{height} | {safe} | GEOMETRY_PASS");
                frames = 0; index++;
            }
